class Pagination():
    def __init__(self,request,data_length,per_num=10,max_show=11):
        ...
        if page == 1:
            ...
            qd['page'] = page -1
            page_list.append(
                '<li><a href="?{}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>'.format(qd.urlencode))
        ...
        if page == total_num:
            ...
            qd['page'] = page + 1
            page_list.append(
                '<li><a href="?{}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>'.format(qd.urlencode))
