...
urlpatterns = [
    ...
    url('^article_add/$', views.article_add, name='article_add'),
    url('^article_edit/(\d+)$', views.article_edit, name='article_edit'),
    url('^user_list/$', views.user_list, name='user_list'),
    url('^category_list/$', views.category_list, name='category_list'),
    url('^category_add/$', views.category_change, name='category_add'),
    url('^category_edit/(\d+)$', views.category_change, name='category_edit'),
